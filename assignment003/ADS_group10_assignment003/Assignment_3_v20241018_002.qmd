...
## Storing prediction file 
 ...
 Finally we se the best model(DT-Random Fine-tuned) to predict the test dataset. The output is a single vector with 79 numeric values) in a file called `predictions.rds`:
